...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    void SetupGameRPC()
    {
        ...
        // Cria as listas de cartas com fallback para deck padrão.
        ...
        if (myDeck.Count == 0 && deckManager != null && deckManager.defaultPlayerDeck != null)
        {
            ...
            Debug.LogWarning("Deck local não encontrado nas propriedades de rede. Usando deck padrão.");
        }
        ...
        if (opponentDeck.Count == 0 && deckManager != null && deckManager.defaultPlayerDeck != null)
        {
            ...
            Debug.LogWarning("Deck do oponente não encontrado nas propriedades de rede. Usando deck padrão.");
        }
